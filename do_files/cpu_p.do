...
mem load -i {work/testcases v2/AFormat-WithPushPop.mem} -filltype value -filldata inst_mem -fillradix symbolic -skip 0 /cpu/Fetch_MODULE/ram

mem load -i {work/testcases v2/AFormat-WithPushPop.mem} -format mti -filltype value -filldata data_mem -fillradix symbolic -skip 0 /cpu/MEMORY_ACCESS_MODULE/D_mem/ram
